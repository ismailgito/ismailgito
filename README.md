...
role       : Performance Marketer + Growth Engineer
status     : Open to Full-Time Roles — Immediate Availability
focus      : Paid Media · CRO · Attribution · AI-Powered Marketing
portfolio  : mohamedismail784.netlify.app
```

> I sit at the intersection of **marketing strategy** and **engineering**.  
> I don't just run campaigns — I build the dashboards, tracking systems, and tools that make those campaigns measurable, scalable, and profitable.
...
Built a web app that converts raw files into **LLM-optimized Markdown**, slashing token consumption and AI API costs.
...
- 🏷️ Automated UTM capture — zero attribution gaps
...
[![Portfolio](https://img.shields.io/badge/Portfolio-000000?style=for-the-badge&logo=vercel&logoColor=white)](https://mohamedismail784.netlify.app/)
